  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-md mx-auto">
      ...
      >
        ...
        <Button
          type="submit"
          className="w-full h-14 bg-indigo-600 hover:bg-indigo-500 text-white font-black text-lg uppercase tracking-wide transition-all shadow-xl shadow-indigo-500/20 rounded-2xl"
        >
          {t("setup.start_game")}
        </Button>
      </form>
